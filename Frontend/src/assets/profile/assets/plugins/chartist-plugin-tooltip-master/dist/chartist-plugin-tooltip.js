    ...
    Chartist.plugins.tooltip = function (options) {
      ...
      return function tooltip(chart) {
        ...
        on('mouseover', tooltipSelector, function (event) {
          ...
          let isPieChart = (chart instanceof Chartist.Pie) ? $point : $point.parentNode;
          let seriesName = (isPieChart) ? $point.parentNode.getAttribute('ct:meta') || $point.parentNode.getAttribute('ct:series-name') : '';
